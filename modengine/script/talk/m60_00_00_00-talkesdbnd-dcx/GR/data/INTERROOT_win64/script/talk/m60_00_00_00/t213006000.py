...
def t213006000_1():
    ...
    t213006000_x5(flag1=3223, flag2=3221, flag3=3222, val1=5, val2=10, val3=12, val4=10, val5=12, actionbutton1=6210,
...
def t213006000_x0(actionbutton1=6210, flag5=6001, flag9=6000, flag10=6000, flag11=6000, flag12=6000,
                  flag4=6000):
    """State 0"""
    while True:
        """State 1"""
...
def t213006000_x3(val2=10, val3=12):
    """State 0,1"""
...
def t213006000_x5(flag1=3223, flag2=3221, flag3=3222, val1=5, val2=10, val3=12, val4=10, val5=12, actionbutton1=6210,
                  flag4=6000, flag5=6001, flag6=6000, flag7=6000, flag8=6000, z1=1, z2=1000000, z3=1000000,
                  z4=1000000, mode1=1, mode2=1):
    """State 0"""
    ...
    while True:
        """State 2"""
        call = t213006000_x22(flag1=flag1, flag2=flag2, flag3=flag3, val1=val1, val2=val2, val3=val3,
...
def t213006000_x6(val1=5, val2=10, val3=12, val4=10, val5=12, actionbutton1=6210, flag4=6000, flag5=6001,
                  flag6=6000, flag7=6000, flag8=6000, z1=1, z2=1000000, z3=1000000, z4=1000000, mode1=1,
                  mode2=1):
    """State 0"""
    while True:
        """State 2"""
        call = t213006000_x9(actionbutton1=actionbutton1, flag4=flag4, flag5=flag5, z2=z2, z3=z3, z4=z4)
        def WhilePaused():
        ...
        if call.Done():
            ...
            Label('L0')
            c1_138(1000000)
            call = t213006000_x13(val1=val1, z1=z1)
            def WhilePaused():
            ...
            """State 6"""
            assert t213006000_x26() and CheckSpecificPersonTalkHasEnded(0) == 1
            continue
        ...
        def ExitPause():
            RemoveMyAggro()
        assert t213006000_x11(val2=val2, val3=val3)
    """Unused"""
    """State 7"""
    return 0

def t213006000_x7(val2=10, val3=12):
    """State 0,1"""
    call = t213006000_x17(val2=val2, val3=val3)
    assert IsPlayerDead() == 1
    """State 2"""
    t213006000_x3(val2=val2, val3=val3)
    Quit()
    """Unused"""
    """State 3"""
    return 0

def t213006000_x8(flag1=3223, val2=10, val3=12):
    """State 0,8"""
    assert t213006000_x32()
    """State 1"""
...
def t213006000_x9(actionbutton1=6210, flag4=6000, flag5=6001, z2=1000000, z3=1000000, z4=1000000):
    """State 0,1"""
    call = t213006000_x10(z5=2000, val6=2000)
    if call.Get() == 1:
        """State 2"""
        assert (t213006000_x0(actionbutton1=actionbutton1, flag5=flag5, flag9=6000, flag10=6000, flag11=6000,
...
def t213006000_x10(z5=_, val6=_):
    """State 0,1"""
    if f203(z5) == 1:
        """State 2"""
...
def t213006000_x11(val2=10, val3=12):
    """State 0"""
    assert GetCurrentStateElapsedFrames() > 1
    """State 5"""
    assert t213006000_x1()
...
def t213006000_x12():
    """State 0,1"""
    assert t213006000_x10(z5=1101, val6=1101)
    """State 2"""
    return 0

def t213006000_x13(val1=5, z1=1):
    """State 0,2"""
    assert t213006000_x23()
    """State 1"""
    call = t213006000_x14()
    if call.Done():
        pass
...
def t213006000_x14():
    """State 0,1"""
    assert t213006000_x10(z5=1000, val6=1000)
    """State 2"""
    return 0

def t213006000_x15(val5=12):
    """State 0,1"""
    call = t213006000_x16()
    if call.Done():
        pass
...
def t213006000_x16():
    """State 0,1"""
    assert t213006000_x10(z5=1100, val6=1100)
    """State 2"""
    return 0

def t213006000_x17(val2=10, val3=12):
    """State 0,5"""
    assert t213006000_x32()
    """State 2"""
...
def t213006000_x18():
    """State 0,2"""
    call = t213006000_x10(z5=1102, val6=1102)
    if call.Get() == 1:
        """State 1"""
        Quit()
    elif call.Done():
...
def t213006000_x19():
    """State 0,1"""
    assert t213006000_x10(z5=1001, val6=1001)
    """State 2"""
    return 0

def t213006000_x20():
    """State 0,1"""
    assert t213006000_x10(z5=1103, val6=1103)
    """State 2"""
    return 0
...
def t213006000_x22(flag1=3223, flag2=3221, flag3=3222, val1=5, val2=10, val3=12, val4=10, val5=12, actionbutton1=6210,
                   flag4=6000, flag5=6001, flag6=6000, flag7=6000, flag8=6000, z1=1, z2=1000000, z3=1000000,
                   z4=1000000, mode1=1, mode2=1):
    """State 0"""
    while True:
        """State 1"""
        RemoveMyAggro()
        call = t213006000_x6(val1=val1, val2=val2, val3=val3, val4=val4, val5=val5, actionbutton1=actionbutton1,
                             flag4=flag4, flag5=flag5, flag6=flag6, flag7=flag7, flag8=flag8, z1=z1,
                             z2=z2, z3=z3, z4=z4, mode1=mode1, mode2=mode2)
        if CheckSelfDeath() == 1 or GetEventFlag(flag1) == 1:
            """State 3"""
            Label('L0')
            call = t213006000_x8(flag1=flag1, val2=val2, val3=val3)
            ...
            """State 2"""
            call = t213006000_x7(val2=val2, val3=val3)
            if CheckSelfDeath() == 1 or GetEventFlag(flag1) == 1:
                Goto('L0')
            ...
            pass
        """State 4"""
        assert t213006000_x31() and not GetEventFlag(9000)
    """Unused"""
    """State 5"""
    return 0
...
def t213006000_x24():
    """State 0,1"""
    assert t213006000_x10(z5=1104, val6=1104)
    """State 2"""
    return 0

def t213006000_x25():
    """State 0,1"""
    call = t213006000_x10(z5=1201, val6=1201)
    if call.Get() == 1:
        """State 2"""
        assert t213006000_x4()
    elif call.Done():
        pass
    """State 3"""
    return 0
...
def t213006000_x26():
    """State 0,1"""
    call = t213006000_x10(z5=1300, val6=1300)
    if call.Get() == 1:
        """State 2"""
        assert t213006000_x4()
    elif call.Done():
...
def t213006000_x27():
    """State 0,1"""
    call = t213006000_x10(z5=1301, val6=1301)
    if call.Get() == 1:
        """State 2"""
        assert t213006000_x4()
    elif call.Done():
...
def t213006000_x28():
    """State 0,1"""
    call = t213006000_x10(z5=1302, val6=1302)
    if call.Get() == 1:
        """State 2"""
        assert t213006000_x4()
    elif call.Done():
...
def t213006000_x29(text1=_, mode3=1):
    """State 0,4"""
    assert t213006000_x2() and CheckSpecificPersonTalkHasEnded(0) == 1
    """State 1"""
...
def t213006000_x30():
    """State 0,1"""
    assert t213006000_x10(z5=1002, val6=1002)
    """State 2"""
    return 0
...
def t213006000_x34():
    ...
    if not GetEventFlag(11102702):
        ...
        if not GetEventFlag(11109205) and not GetEventFlag(11102702):
            ...
            assert t213006000_x29(text1=21300100, mode3=1)
            """State 2"""
            ...
            assert t213006000_x29(text1=21304200, mode3=1)
            """State 8"""
            ...
            assert t213006000_x29(text1=21308100, mode3=1)
            """State 6"""
            ...
            if not GetEventFlag(11109206):
                ...
                assert t213006000_x29(text1=21303000, mode3=1)
                """State 4"""
                ...
                assert t213006000_x29(text1=21301000, mode3=1)
        else:
            Goto('L0')
        """State 3"""
        ...
        assert t213006000_x29(text1=21300200, mode3=1)
    """State 15"""
    return 0
...
def t213006000_x36():
    ...
    assert t213006000_x29(text1=21305100, mode3=1)
    while True:
        """State 5"""
        c1_110()
        """State 1"""
        ...
        if GetTalkListEntryResult() == 1:
            ...
            assert t213006000_x29(text1=21305200, mode3=1)
            """State 6"""
            ...
            assert t213006000_x29(text1=21305300, mode3=1)
        elif GetTalkListEntryResult() == 4:
            pass
        """State 10"""
        return 0
...
def t213006000_x38():
    ...
    if not GetEventFlag(11109238):
        ...
        assert t213006000_x29(text1=21310000, mode3=1)
        """State 2"""
        ...
        if not GetEventFlag(9114):
            ...
            assert t213006000_x29(text1=21310100, mode3=1)
        else:
            """State 6"""
            # talk:21312300:"I'll smith...as long as you like."
            assert t213006000_x29(text1=21312300, mode3=1)
    """State 7"""
    return 0
...
def t213006000_x40():
    ...
    assert t213006000_x29(text1=21311000, mode3=1)
    """State 1"""
...
def t213006000_x42():
    ...
    assert t213006000_x29(text1=21314000, mode3=1)
    """State 1"""
...
def t213006000_x43():
    ...
    assert t213006000_x29(text1=21315000, mode3=1)
    """State 1"""
...
def t213006000_x45():
    ...
    assert t213006000_x29(text1=21306000, mode3=1)
    """State 1"""
...
def t213006000_x47():
    ...
    assert t213006000_x29(text1=21304100, mode3=1)
    """State 1"""
...
def t213006000_x48():
    ...
    assert t213006000_x29(text1=21305000, mode3=1)
    """State 1"""
...
def t213006000_x49():
    ...
    assert t213006000_x29(text1=21307000, mode3=1)
    """State 1"""
...
def t213006000_x50():
    ...
    assert t213006000_x29(text1=21309000, mode3=1)
    """State 1"""
...
def t213006000_x51():
    ...
    assert t213006000_x29(text1=21302000, mode3=1)
    """State 1"""
...
def t213006000_x52():
    ...
    assert t213006000_x29(text1=21302100, mode3=1)
    """State 1"""
...
def t213006000_x54():
    ...
    assert t213006000_x29(text1=21313000, mode3=1)
    """State 1"""
...
def t213006000_x55():
    ...
    assert t213006000_x29(text1=21313100, mode3=1)
    """State 1"""
...
def t213006000_x56():
    ...
    assert t213006000_x29(text1=21311100, mode3=1)
    """State 1"""
...
def t213006000_x58():
    ...
    assert t213006000_x29(text1=21314100, mode3=1)
    """State 1"""
