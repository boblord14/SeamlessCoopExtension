...
def t220026000_1():
    ...
    t220026000_x6(flag1=3663, flag2=3661, flag3=3662, val1=5, val2=10, val3=12, val4=70, val5=70, actionbutton1=6000,
...
def t220026000_2000():
    """State 0,2,3"""
    assert t220026000_x42()
    """State 1"""
    c1_120(2000)
    Quit()

def t220026000_x0(actionbutton1=_, flag5=6001, flag9=6000, flag10=6000, flag11=6000, flag12=6000, flag4=6000):
    """State 0"""
    while True:
        """State 1"""
...
def t220026000_x4(val2=10, val3=12):
    """State 0,1"""
...
def t220026000_x6(flag1=3663, flag2=3661, flag3=3662, val1=5, val2=10, val3=12, val4=70, val5=70, actionbutton1=6000,
                  flag4=6000, flag5=6001, flag6=6000, flag7=6000, flag8=6000, z1=1, z2=1000000, z3=1000000,
                  z4=1000000, mode1=1, mode2=1):
    """State 0"""
    ...
    while True:
        """State 2"""
        call = t220026000_x23(flag1=flag1, flag2=flag2, flag3=flag3, val1=val1, val2=val2, val3=val3,
...
def t220026000_x7(val1=5, val2=10, val3=12, val4=70, val5=70, actionbutton1=6000, flag4=6000, flag5=6001,
                  flag6=6000, flag7=6000, flag8=6000, z1=1, z2=1000000, z3=1000000, z4=1000000, mode1=1,
                  mode2=1):
    """State 0"""
    while True:
        """State 2"""
        call = t220026000_x10(actionbutton1=actionbutton1, flag4=flag4, flag5=flag5, z2=z2, z3=z3, z4=z4)
        def WhilePaused():
        ...
        if call.Done():
            ...
            Label('L0')
            c1_138(1000000)
            call = t220026000_x14(val1=val1, z1=z1)
            def WhilePaused():
            ...
            """State 6"""
            assert t220026000_x27() and CheckSpecificPersonTalkHasEnded(0) == 1
            continue
        ...
        def ExitPause():
            RemoveMyAggro()
        assert t220026000_x12(val2=val2, val3=val3)
    """Unused"""
    """State 7"""
    return 0

def t220026000_x8(val2=10, val3=12):
    """State 0,1"""
    call = t220026000_x18(val2=val2, val3=val3)
    assert IsPlayerDead() == 1
    """State 2"""
    t220026000_x4(val2=val2, val3=val3)
    Quit()
    """Unused"""
    """State 3"""
    return 0

def t220026000_x9(flag1=3663, val2=10, val3=12):
    """State 0,8"""
    assert t220026000_x36()
    """State 1"""
...
def t220026000_x10(actionbutton1=6000, flag4=6000, flag5=6001, z2=1000000, z3=1000000, z4=1000000):
    """State 0,1"""
    call = t220026000_x11(z6=2000, val6=2000)
    if call.Get() == 1:
        """State 2"""
        assert (t220026000_x0(actionbutton1=actionbutton1, flag5=flag5, flag9=6000, flag10=6000, flag11=6000,
...
def t220026000_x11(z6=_, val6=_):
    """State 0,1"""
    if f203(z6) == 1:
        """State 2"""
...
def t220026000_x12(val2=10, val3=12):
    """State 0"""
    assert GetCurrentStateElapsedFrames() > 1
    """State 5"""
    assert t220026000_x1()
...
def t220026000_x13():
    """State 0,1"""
    assert t220026000_x11(z6=1101, val6=1101)
    """State 2"""
    return 0

def t220026000_x14(val1=5, z1=1):
    """State 0,2"""
    assert t220026000_x24()
    """State 1"""
    call = t220026000_x15()
    if call.Done():
        pass
        ...
        """State 3"""
        assert t220026000_x26()
    """State 4"""
    return 0

def t220026000_x15():
    """State 0,1"""
    assert t220026000_x11(z6=1000, val6=1000)
    """State 2"""
    return 0

def t220026000_x16(val5=70):
    """State 0,1"""
    call = t220026000_x17()
    if call.Done():
        pass
        ...
        """State 2"""
        assert t220026000_x27()
    """State 3"""
    return 0

def t220026000_x17():
    """State 0,1"""
    assert t220026000_x11(z6=1100, val6=1100)
    """State 2"""
    return 0

def t220026000_x18(val2=10, val3=12):
    """State 0,5"""
    assert t220026000_x36()
    """State 2"""
...
def t220026000_x19():
    """State 0,2"""
    call = t220026000_x11(z6=1102, val6=1102)
    if call.Get() == 1:
        """State 1"""
        Quit()
    elif call.Done():
...
def t220026000_x20():
    """State 0,1"""
    assert t220026000_x11(z6=1001, val6=1001)
    """State 2"""
    return 0

def t220026000_x21():
    """State 0,1"""
    assert t220026000_x11(z6=1103, val6=1103)
    """State 2"""
    return 0
...
def t220026000_x23(flag1=3663, flag2=3661, flag3=3662, val1=5, val2=10, val3=12, val4=70, val5=70, actionbutton1=6000,
                   flag4=6000, flag5=6001, flag6=6000, flag7=6000, flag8=6000, z1=1, z2=1000000, z3=1000000,
                   z4=1000000, mode1=1, mode2=1):
    """State 0"""
    while True:
        """State 1"""
        RemoveMyAggro()
        call = t220026000_x7(val1=val1, val2=val2, val3=val3, val4=val4, val5=val5, actionbutton1=actionbutton1,
                             flag4=flag4, flag5=flag5, flag6=flag6, flag7=flag7, flag8=flag8, z1=z1,
                             z2=z2, z3=z3, z4=z4, mode1=mode1, mode2=mode2)
        if CheckSelfDeath() == 1 or GetEventFlag(flag1) == 1:
            """State 3"""
            Label('L0')
            call = t220026000_x9(flag1=flag1, val2=val2, val3=val3)
            ...
            """State 2"""
            call = t220026000_x8(val2=val2, val3=val3)
            if CheckSelfDeath() == 1 or GetEventFlag(flag1) == 1:
                Goto('L0')
            ...
            pass
        """State 4"""
        assert t220026000_x35() and (not GetEventFlag(9000) and not IsPlayerDead())
    """Unused"""
    """State 5"""
    return 0
...
def t220026000_x24():
    """State 0,1"""
    assert t220026000_x25()
    """State 2"""
    return 0

def t220026000_x25():
    """State 0,1"""
    assert t220026000_x11(z6=1104, val6=1104)
    """State 2"""
    return 0

def t220026000_x26():
    """State 0,1"""
    call = t220026000_x11(z6=1201, val6=1201)
    if call.Get() == 1:
        """State 2"""
        assert t220026000_x5()
    elif call.Done():
        pass
    """State 3"""
    return 0
...
def t220026000_x27():
    """State 0,1"""
    call = t220026000_x11(z6=1300, val6=1300)
    if call.Get() == 1:
        """State 2"""
        assert t220026000_x5()
    elif call.Done():
...
def t220026000_x28():
    """State 0,1"""
    call = t220026000_x11(z6=1301, val6=1301)
    if call.Get() == 1:
        """State 2"""
        assert t220026000_x5()
    elif call.Done():
...
def t220026000_x29():
    """State 0,1"""
    call = t220026000_x11(z6=1302, val6=1302)
    if call.Get() == 1:
        """State 2"""
        assert t220026000_x5()
    elif call.Done():
...
def t220026000_x30(text3=_, mode5=1):
    """State 0,4"""
    assert t220026000_x2() and CheckSpecificPersonTalkHasEnded(0) == 1
    """State 1"""
...
def t220026000_x31(text2=_, z5=_, mode4=1):
    """State 0,5"""
    assert t220026000_x33() and CheckSpecificPersonTalkHasEnded(0) == 1
    """State 2"""
    SetEventFlag(z5, 1)
    """State 1"""
...
def t220026000_x32(text1=_, mode3=1):
    """State 0,4"""
    assert t220026000_x33() and CheckSpecificPersonTalkHasEnded(0) == 1
    """State 1"""
...
def t220026000_x34():
    """State 0,1"""
    assert t220026000_x11(z6=1002, val6=1002)
    """State 2"""
    return 0
...
def t220026000_x38():
    ...
    if not GetEventFlag(13009256):
        ...
        assert t220026000_x32(text1=22081000, mode3=1)
    else:
        """State 3"""
        # talk:22010200:"Good sir, I can't believe your heart was in it at all."
        assert t220026000_x32(text1=22010200, mode3=1)
    """State 4"""
    return 0
...
def t220026000_x40():
    ...
    if not GetEventFlag(13009256):
        ...
        if not GetEventFlag(1043399303):
            ...
            assert (t220026000_x31(text2=22080200, z5=1043399303, mode4=1) and CheckSpecificPersonTalkHasEnded(0)
                    == 1)
            """State 11"""
            # talk:22080300:"Then there's nothing left to say, except..."
            assert t220026000_x32(text1=22080300, mode3=1)
        else:
            """State 4"""
            pass
    else:
        ...
        if not GetEventFlag(13009261):
            ...
            assert t220026000_x31(text2=22009105, z5=13009261, mode4=1)
        else:
            """State 6"""
            ...
            if not GetEventFlag(13002715):
                ...
                assert t220026000_x31(text2=22009110, z5=13002715, mode4=1)
            else:
                """State 8"""
                pass
    """State 1"""
...
def t220026000_x41():
    ...
    if not GetEventFlag(13009256):
        ...
        assert t220026000_x32(text1=22082000, mode3=1)
    else:
        """State 2"""
        pass
    """State 4"""
...
def t220026000_x42():
    ...
    while True:
        ...
        if GetEventFlag(3665) == 1:
            ...
            call = t220026000_x0(actionbutton1=6270, flag5=6001, flag9=6000, flag10=6000, flag11=6000,
...
def t220026000_x43():
    ...
    if not GetEventFlag(1043399306):
        ...
        assert t220026000_x44()
    elif not GetEventFlag(1043399311):
        """State 3"""
        def WhilePaused():
            RequestAnimation(20032, -1)
        assert t220026000_x62()
    else:
        """State 4"""
        def WhilePaused():
            RequestAnimation(20025, -1)
        assert t220026000_x45()
    """State 5"""
    return 0
...
def t220026000_x44():
    ...
    if not GetEventFlag(1043399305):
        ...
        assert t220026000_x30(text3=22000200, mode5=1)
        """State 11"""
        ...
        assert t220026000_x30(text3=22000900, mode5=1)
    """State 3"""
    ClearTalkListData()
    """State 7"""
    ...
    if GetTalkListEntryResult() == 1:
        ...
        assert t220026000_x30(text3=22000230, mode5=1)
    elif GetTalkListEntryResult() == 2:
        """State 16"""
        # talk:22000800:"I see. More's the pity."
        assert t220026000_x30(text3=22000800, mode5=1)
    else:
        """State 9"""
        pass
    """State 17"""
...
def t220026000_x45():
    ...
    if not GetEventFlag(1043399307):
        ...
        assert t220026000_x30(text3=22000600, mode5=1)
        """State 2"""
        SetEventFlag(1043399307, 1)
        """State 6"""
        # lot:101700:Exalted Flesh
        assert t220026000_x3(lot1=101700)
        ...
        assert t220026000_x30(text3=22000700, mode5=1)
        """State 3"""
        SetEventFlag(1043399308, 1)
    else:
        """State 7"""
        # talk:22001300:"I'm heading eastward."
        assert t220026000_x30(text3=22001300, mode5=1)
    """State 8"""
    return 0
...
def t220026000_x46():
    ...
    if GetEventFlag(1043392716) == 1 or GetEventFlag(1043399306) == 1:
        """State 4"""
        # actionbutton:6270:"Talk"
        assert (t220026000_x0(actionbutton1=6270, flag5=6001, flag9=6000, flag10=6000, flag11=6000, flag12=6000,
                flag4=6000))
    else:
        """State 2"""
        SetEventFlag(32009203, 0)
        """State 3"""
        assert t220026000_x47()
    """State 5"""
    return 0
...
def t220026000_x47():
    ...
    while True:
        """State 2"""
        # actionbutton:6270:"Talk"
        call = t220026000_x0(actionbutton1=6270, flag5=6001, flag9=6000, flag10=6000, flag11=6000, flag12=6000,
                             flag4=6000)
        if call.Done():
            break
        elif call.Done():
        ...
        call = t220026000_x31(text2=22000100, z5=1043392713, mode4=1)
        if call.Done():
            pass
        ...
        if True:
            ...
            if RelativeAngleBetweenTwoPlayers_SpecifyAxis(180) < 110:
                ...
                if not GetEventFlag(1043399311) and GetSelfHP() < 93:
                    ...
                    """State 21"""
                    # talk:22000500:"Ahhh!"
                    assert t220026000_x31(text2=22000500, z5=1043399311, mode4=1)
                    """State 17"""
                    ...
                    """State 23"""
                    # talk:22000310:"Ouuch!"
                    assert t220026000_x32(text1=22000310, mode3=1)
                    ...
                    """State 22"""
                    # talk:22000300:"Ah!"
                    assert t220026000_x32(text1=22000300, mode3=1)
            else:
                """State 24"""
                # talk:22001200:"G-good gosh, stop, please! That's my face!"
                assert t220026000_x32(text1=22001200, mode3=1)
        else:
            """State 20"""
            # talk:22000400:"S-stop please! That's a little too rough for me, friend."
            assert t220026000_x31(text2=22000400, z5=1043399309, mode4=1)
    else:
        """State 10"""
        if not GetEventFlag(1043392711):
            """State 25"""
...
def t220026000_x49():
    ...
    if not GetEventFlag(32070560):
        ...
        def WhilePaused():
            RequestAnimation(20025, -1)
        assert t220026000_x63()
    else:
        """State 3"""
        def WhilePaused():
            RequestAnimation(20025, -1)
        assert t220026000_x64()
    """State 4"""
    return 0
...
def t220026000_x50():
    ...
    if not GetEventFlag(1051369255):
        ...
        if not GetEventFlag(1043399313):
            ...
            assert t220026000_x30(text3=22004100, mode5=1)
            """State 4"""
            SetEventFlag(1043399313, 1)
        else:
            """State 7"""
            # talk:22004000:"Ah, you came, how delightful!"
            assert t220026000_x30(text3=22004000, mode5=1)
        """State 1"""
        SetEventFlag(1051369255, 1)
    else:
        """State 6"""
        # talk:22004200:"Be sure to get a good vantage, my friend."
        assert t220026000_x30(text3=22004200, mode5=1)
    """State 8"""
    return 0
...
def t220026000_x52():
    ...
    if not GetEventFlag(1039449206):
        ...
        def WhilePaused():
            RequestAnimation(20032, -1)
        assert t220026000_x65()
    elif not GetEventFlag(1039449214):
        """State 4"""
        def WhilePaused():
            RequestAnimation(20032, -1)
        assert t220026000_x66()
    else:
        """State 5"""
        def WhilePaused():
            RequestAnimation(20025, -1)
        assert t220026000_x69()
    """State 6"""
    return 0
...
def t220026000_x53():
    ...
    if not GetEventFlag(1035539205):
        """State 4"""
        # talk:22008100:"Nnngh!"
        assert t220026000_x30(text3=22008100, mode5=1)
        """State 2"""
        ...
        """State 7"""
        # lot:101720:Jar
        assert t220026000_x3(lot1=101720)
        """State 6"""
        # talk:22008110:"But oh, it's hardly more than lukewarm here."
        assert t220026000_x30(text3=22008110, mode5=1)
    else:
        """State 5"""
        # talk:22008300:"Perhaps I'll head eastward."
        assert t220026000_x30(text3=22008300, mode5=1)
    """State 8"""
    return 0
...
def t220026000_x54():
    ...
    if not GetEventFlag(13009258):
        ...
        def WhilePaused():
            RequestAnimation(20025, -1)
        assert t220026000_x59()
    else:
        """State 4"""
        def ExitPause():
            SetEventFlag(13009257, 1)
        assert t220026000_x60()
    """State 5"""
    return 0
...
def t220026000_x56():
    ...
    while True:
        ...
        call = t220026000_x31(text2=22006000, z5=1039442703, mode4=1)
        if call.Done():
            pass
        elif GetEventFlag(1043392716) == 1:
            """State 1"""
...
def t220026000_x57():
    ...
    if GetEventFlag(1039449206) == 1:
        ...
        if not GetEventFlag(1039449207):
            """State 7"""
            assert t220026000_x70()
        else:
            """State 8"""
            assert t220026000_x71()
    else:
        """State 3"""
        if not GetEventFlag(1043392711):
            """State 9"""
...
def t220026000_x58():
    ...
    while True:
        ...
        call = t220026000_x0(actionbutton1=6271, flag5=6001, flag9=6000, flag10=6000, flag11=6000, flag12=6000,
                             flag4=6000)
        if call.Done():
            break
        elif call.Done():
        ...
        """State 4"""
        # talk:22008000:"Ngh!"
        call = t220026000_x31(text2=22008000, z5=1035532703, mode4=1)
        if call.Done():
            pass
...
def t220026000_x59():
    ...
    if not GetEventFlag(13009255):
        ...
        if not GetEventFlag(13009259):
            ...
            assert t220026000_x30(text3=22009200, mode5=1)
        else:
            """State 7"""
            # talk:22009000:"Ah, I see you've finally made it here yourself."
            assert t220026000_x30(text3=22009000, mode5=1)
        """State 1"""
        SetEventFlag(13009255, 1)
    else:
        """State 6"""
        # talk:22009100:"You are ready then, I take it?"
        assert t220026000_x30(text3=22009100, mode5=1)
        """State 3"""
...
def t220026000_x60():
    ...
    call = t220026000_x32(text1=22010100, mode3=1)
...
def t220026000_x61():
    ...
    while True:
        ...
        if call.Done():
            ...
            assert t220026000_x32(text1=22010000, mode3=1)
    """State 6"""
    return 0
...
def t220026000_x62():
    ...
    if not GetEventFlag(1035532709):
        ...
        assert t220026000_x30(text3=22001000, mode5=1)
    else:
        """State 3"""
        # talk:22001100:"Don't stop now, friend."
        assert t220026000_x30(text3=22001100, mode5=1)
    """State 4"""
    return 0
...
def t220026000_x63():
    ...
    if not GetEventFlag(32009205):
        ...
        if GetEventFlag(1043399313) == 1:
            ...
            assert t220026000_x30(text3=22002000, mode5=1)
        elif not GetEventFlag(1043399313):
            """State 7"""
            # talk:22002200:"Ah, if it isn't a Tarnished warrior."
            assert t220026000_x30(text3=22002200, mode5=1)
            """State 4"""
            SetEventFlag(1043399313, 1)
        """State 3"""
        ...
        assert t220026000_x30(text3=22002100, mode5=1)
    """State 8"""
    return 0
...
def t220026000_x64():
    ...
    if not GetEventFlag(32009206):
        ...
        if GetEventFlag(1043399313) == 1 and not GetEventFlag(32009205):
            """State 6"""
            # talk:22003100:"...!"
            assert t220026000_x30(text3=22003100, mode5=1)
        elif GetEventFlag(1043399313) == 1 and GetEventFlag(32009205) == 1:
            """State 8"""
            # talk:22003000:"...!"
            assert t220026000_x30(text3=22003000, mode5=1)
        elif not GetEventFlag(1043399313):
            """State 7"""
            # talk:22003200:"...!"
            assert t220026000_x30(text3=22003200, mode5=1)
            """State 4"""
            SetEventFlag(1043399313, 1)
        """State 3"""
        ...
        assert t220026000_x30(text3=22003300, mode5=1)
    """State 9"""
    return 0
...
def t220026000_x65():
    ...
    if not GetEventFlag(1039449205):
        ...
        if not GetEventFlag(1043399306):
            ...
            assert t220026000_x30(text3=22006900, mode5=1)
        else:
            """State 18"""
            # talk:22006100:"Ahh, hello! How nice it is to see a friendly face!"
            assert t220026000_x30(text3=22006100, mode5=1)
        """State 12"""
        SetEventFlag(1043392716, 1)
        """State 1"""
        ...
        assert t220026000_x30(text3=22006500, mode5=1)
    """State 3"""
    ClearTalkListData()
    """State 7"""
    # action:22201000:"Help him out"
    ...
    if GetTalkListEntryResult() == 1:
        ...
        if not GetEventFlag(1043399306):
            ...
            assert t220026000_x30(text3=22014100, mode5=1)
        else:
            """State 19"""
            # talk:22006113:"My thanks in advance, I know you're the man for the job!"
            assert t220026000_x30(text3=22006113, mode5=1)
    elif GetTalkListEntryResult() == 2:
        """State 17"""
        # talk:22006400:"I see. More's the pity."
        assert t220026000_x30(text3=22006400, mode5=1)
    else:
        """State 9"""
        pass
    """State 20"""
...
def t220026000_x66():
    ...
    if not GetEventFlag(1039449211):
        """State 2"""
        assert t220026000_x67()
    else:
        """State 3"""
        assert t220026000_x68()
    """State 4"""
    return 0
...
def t220026000_x67():
    ...
    assert t220026000_x30(text3=22006600, mode5=1)
    """State 2"""
    return 0
    ...
    if RelativeAngleBetweenTwoPlayers_SpecifyAxis(180) < 110:
        ...
        if not GetEventFlag(1039449211):
            ...
            if GetWorkValue(0) > 2 or GetSelfHP() < 95:
                ...
                assert t220026000_x31(text2=22006300, z5=1039449211, mode4=1)
                """State 4"""
                SetWorkValue(0, 0)
            elif GetWorkValue(0) > 1:
                """State 12"""
                # talk:22006210:"Ouuch!"
                assert t220026000_x32(text1=22006210, mode3=1)
                """State 2"""
                SetWorkValue(0, 2)
            elif GetWorkValue(0) > 0:
                """State 14"""
                # talk:22006200:"Ah!"
                assert t220026000_x32(text1=22006200, mode3=1)
                """State 3"""
                SetWorkValue(0, 1)
        else:
            """State 6"""
            if GetWorkValue(0) > 4:
                """State 19"""
                # talk:22013500:"Argh!"
                assert t220026000_x31(text2=22013500, z5=1039442704, mode4=1)
            elif GetWorkValue(0) > 3:
                """State 15"""
                # talk:22013400:"Argh! No!"
                assert t220026000_x32(text1=22013400, mode3=1)
                """State 10"""
                SetWorkValue(0, 4)
            elif GetWorkValue(0) > 2:
                """State 16"""
                # talk:22013300:"I'll break! I'll break before I'm out!"
                assert t220026000_x32(text1=22013300, mode3=1)
                """State 9"""
                SetWorkValue(0, 3)
            elif GetWorkValue(0) > 1:
                """State 17"""
                # talk:22013200:"My lower half is stuck on something down there!"
                assert t220026000_x32(text1=22013200, mode3=1)
                """State 8"""
                SetWorkValue(0, 2)
            elif GetWorkValue(0) > 0:
                """State 20"""
                # talk:22013100:"Argh! Cease! Please!"
                assert t220026000_x32(text1=22013100, mode3=1)
                """State 7"""
                SetWorkValue(0, 1)
    else:
        """State 18"""
...
def t220026000_x71():
    ...
    if RelativeAngleBetweenTwoPlayers_SpecifyAxis(180) < 110:
        ...
        if GetSelfHP() < 90 and GetWorkValue(1) > 1:
            ...
            """State 13"""
            # talk:22007100:"Nnngh!"
            assert t220026000_x31(text2=22007100, z5=1039449214, mode4=1)
            """State 10"""
            SetEventFlag(1043392715, 0)
            SetEventFlag(1043392711, 0)
            """State 8"""
            ...
            """State 15"""
            # talk:22007010:"Nngh!"
            assert t220026000_x32(text1=22007010, mode3=1)
            """State 3"""
            SetWorkValue(1, 2)
        elif GetWorkValue(1) > 0:
            """State 14"""
            # talk:22007000:"Ngh!"
            assert t220026000_x32(text1=22007000, mode3=1)
            """State 4"""
            SetWorkValue(1, 1)
    else:
        """State 16"""
