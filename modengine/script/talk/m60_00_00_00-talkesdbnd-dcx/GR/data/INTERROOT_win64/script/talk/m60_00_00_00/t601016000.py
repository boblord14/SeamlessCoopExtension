...
def t601016000_1():
    """State 0,1"""
    t601016000_x0(z1=101950, z2=101974)
    Quit()

def t601016000_x0(z1=101950, z2=101974):
    """State 0"""
    if not IsClientPlayer():
        """State 1"""
        Label('L0')
        call = t601016000_x1(z1=z1, z2=z2)
        if IsClientPlayer() == 1:
            """State 2"""
            Label('L1')
            call = t601016000_x2()
...
def t601016000_x1(z1=101950, z2=101974):
    """State 0"""
    while True:
        """State 2"""
        # actionbutton:6580:"Examine altar"
        assert (t601016000_x5(actionbutton1=6580, flag1=6001, flag2=6000, flag3=6000, flag4=6000, flag5=6000,
                flag6=6000))
        """State 1"""
        ...
        call = t601016000_x3(z1=z1, z2=z2)
        def WhilePaused():
...
def t601016000_x3(z1=101950, z2=101974):
    """State 0"""
    while True:
        """State 1"""
        ClearTalkListData()
...
def t601016000_x5(actionbutton1=6580, flag1=6001, flag2=6000, flag3=6000, flag4=6000, flag5=6000, flag6=6000):
    """State 0"""
    while True:
        """State 1"""
