...
$Event(0, Default, function() {
    InitializeEvent(0, 1024622222, 0);
...
L0:
    WaitFor(PlayerIsInOwnWorld() && EventFlag(9130));
    SetSpEffect(10000, 4280);
    SetSpEffect(10000, 4282);
...
$Event(1040, Restart, function() {
    ...
    WaitFor(timeMap || mapFlagOnline || online9 || EventFlag(9989));
    if (!online9.Passed) {
...
$Event(1024622222, Default, function() {
